...
from langchain_community.chat_models import ChatOllama  # Using LangChain's LLM
from langchain.chains import LLMChain
from langchain.prompts import PromptTemplate
from .utils import get_embedding, double_check_json_output
...
class OrderTakingAgent:
    def __init__(self, recommendation_agent):
        ...
        self.prompt = PromptTemplate(
            input_variables=["conversation", "menu", "rules"],
            template="""
            ...
            ```json
            {{
                "chain of thought": "Explain step logic here...",
                "step number": "Determine which step you are on.",
    ...
    def get_response(self, messages):
        ...
        # Retrieve last conversation memory
        ...
        # Call LangChain LLMChain
        chatbot_output = self.chain.run({"conversation": conversation, "menu": menu, "rules": rules})
        chatbot_output = double_check_json_output(self.model_name, chatbot_output)
        return self.postprocess(chatbot_output, messages, asked_recommendation_before)
    ...
    def postprocess(self, output, messages, asked_recommendation_before):
        ...
        # Offer recommendations only once
...
#         return self.postprocess(chatbot_output, input_messages, asked_recommendation_before)
