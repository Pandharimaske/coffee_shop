...
from .utils import get_chatbot_response , get_embedding , double_check_json_output , is_valid_json , re_prompt_for_json_fix
import dotenv
dotenv.load_dotenv()
import pandas as pd
...
class OrderTakingAgent():
    ...
    def get_response(self , messages):
        ...
        # if not is_valid_json(chatbot_output):
        #     chatbot_output = re_prompt_for_json_fix(self.model_name , chatbot_output)
        # Double check JSON
